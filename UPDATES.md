...
- **Deep analysis of ACTUAL matches (2026-09-24):**
  ...
  - **Systematic test of unique pattern (block 40)** as Vigenère key (all rotations, autokey, running key, reversed): Best result 4.66% (reversed, offset 21) - still in noise floor.
